...
function renderCard(r, delay) {
    ...
    card.className = "bg-white rounded-2xl shadow-sm p-5 border-2 border-grey-200 hover:shadow-lg hover:border-orange-400 flex flex-col opacity-0 translate-y-4 transition-all duration-500";
    ...
    card.innerHTML = `
            ...
            <p class="text-xs text-slate-500 mb-3 truncate">
                ...
                <a href="https://tsdr.uspto.gov/#caseNumber=${r.sn}&caseType=SERIAL_NO&searchType=statusSearch" 
                   target="_blank" class="inline-flex items-center gap-1 font-bold hover:text-orange-500 transition-colors">
                    <span>${r.sn || "—"}</span>
